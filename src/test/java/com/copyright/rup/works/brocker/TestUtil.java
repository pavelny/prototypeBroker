...
public class TestUtil {
    ...
    public static final int COUNT_WORK_OBJECT = 10;//1_000_000
    ...
    public static List<IWork> works;
    ...
    private static String generateJsonStringForXstreame() {
        ...
        sb.append("{")
                ...
                .append("\"deathYear\": \"TestSecondAuthorDeathYear\"")
                .append("}")
                .append("],")
                ...
                .append("\"editors\": [")
                .append("{")
                .append("\"name\": \"TestEditorName\",")
                .append("\"role\": \"TestEditorRole\",")
                .append("\"affiliation\": {")
                .append("\"@class\": \"com.copyright.rup.works.domain.impl.Affiliation\",")
                .append("\"address\": \"TestEditorAffiliationAddress\",")
                .append("\"country\": \"TestEditorAffiliationCountry\"")
                .append("}")
                .append("}")
                .append("],")
                .append("\"language\": {")
                ...
                .append("\"languageRole\": \"TestLanguageType\"")
                .append("},")
                ...
                .append("\"status\": \"TestPublishetStatus\",")
                .append("\"sortOrder\": 1").append("},")
                .append("\"titles\": [").append("{")
                .append("\"title\": \"TestFirstTitle\",")
                .append("\"volume\": \"TestFirstTitleVolume\",")
                .append("\"type\": \"TestFirstTitleType\",")
                .append("\"edition\": \"TestFirstTitleEdition\"").append("},")
                .append("{").append("\"title\": \"TestSecondtTitle\",")
                .append("\"volume\": \"TestSecondTitleVolume\",")
                .append("\"type\": \"TestSecondTitleType\",")
                .append("\"edition\": \"TestSecondTitleEdition\"").append("}")
                .append("],").append("\"audience\": [").append("[")
                .append("\"TestFirstAudience\",")
                .append("\"TestSecondAudience\",")
                .append("\"TestThirdAudience\"").append("]").append("]")
                .append("}");
        return sb.toString();
    }
}
